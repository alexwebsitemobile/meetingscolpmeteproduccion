...
<footer itemscope itemprop="http://schema.org/WPFooter" class="footer text-center-xs">
    ...
    <?php } ?>
        <div class="container-blue pdtb20" id="footer-blue">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="brd-right">
                    ...
                    <div class="col-sm-4 tg-verticalmiddle">
                        <div style="margin-bottom: 15px;">
                            <img src="https://home.meetingscomplete.com/wp-content/uploads/2017/04/Recurso-1.png" class="img-responsives">
                        </div>
                        <div style="margin-bottom: 15px;">
